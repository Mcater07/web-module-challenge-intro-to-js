...
Do the following:   
   ...
   HINT: no function required
*/
let firstThing = 'Teddy';
let secondThing = 'Oso';
if(secondThing === 'Great dog'){
  secondThing = 'Oso';
}else{
  firstThing = 'Teddy';
}
...
console.log('task 1d', multiply(7, 7));
...
console.log('task6', annoyingSong(5));
